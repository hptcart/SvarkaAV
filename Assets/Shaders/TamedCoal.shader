...
Shader "TamedCoal"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float mulTime22 = _Time.y * -1.0;
			float4 appendResult26 = (float4(ase_worldPos.x , ( mulTime22 + ase_worldPos.y ) , ase_worldPos.z , 0.0));
			float simplePerlin3D19 = snoise( appendResult26.xyz*_noise );
			simplePerlin3D19 = simplePerlin3D19*0.5 + 0.5;
			float saferPower12 = abs( ( 1.0 - voroi1 ) );
			float3 hsvTorgb15 = HSVToRGB( float3(0.05,1.0,pow( saferPower12 , 20.0 )) );
			o.Emission = ( ( _Tamed * simplePerlin3D19 ) * hsvTorgb15 );
...
Node;AmplifyShaderEditor.SimpleAddOpNode;27;-251.5843,-537.5479;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
